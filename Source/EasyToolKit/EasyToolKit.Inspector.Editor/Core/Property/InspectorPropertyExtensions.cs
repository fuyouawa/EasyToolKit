...
{
    /// <summary>
    /// Provides extension methods for InspectorProperty to simplify common operations.
    /// </summary>
    public static class InspectorPropertyExtensions
    {
        ...
        /// </summary>
        /// <param name="property">The InspectorProperty to draw.</param>
        ...
        /// <param name="property">The InspectorProperty to get persistent context for.</param>
        ...
        /// <returns>A LocalPersistentContext instance for the specified key.</returns>
