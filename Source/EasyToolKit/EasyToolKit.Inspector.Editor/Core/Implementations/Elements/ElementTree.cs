...
//
//     public IValueStructureResolverFactory StructureResolverFactory { get; }
//     public IValueOperationResolverFactory OperationResolverFactory { get; }
...
//
//         StructureResolverFactory = new DefaultValueStructureResolverFactory();
//         OperationResolverFactory = new DefaultValueOperationResolverFactory();
//         AttributeResolverFactory = new DefaultAttributeResolverFactory();
//         DrawerChainResolverFactory = new DefaultDrawerChainResolverFactory();
//         GroupResolverFactory = new DefaultGroupResolverFactory();
//
