...
{
    /// <summary>
    /// Represents a group element in the inspector tree. Groups are controlled by <see cref="BeginGroupAttribute"/> (e.g., <see cref="FoldoutGroupAttribute"/>) and <see cref="EndGroupAttribute"/> (e.g., <see cref="EndFoldoutGroupAttribute"/>).
