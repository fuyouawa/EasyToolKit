...
namespace EasyToolKit.Inspector.Editor
{
    ...
    public class ListOperation<TOwner, TCollection, TElement> : OrderedCollectionOperation<TOwner, TCollection, TElement>
        where TCollection : IList<TElement>
    {
        public ListOperation([NotNull] IPropertyOperation<TOwner, TCollection> auxiliaryOperation) : base(auxiliaryOperation)
        {
        }
        ...
        public override void InsertElementAt(ref TCollection collection, int index, TElement value)
        {
            if (collection == null)
                throw new ArgumentNullException(nameof(collection));
        ...
        public override void RemoveElementAt(ref TCollection collection, int index)
        {
            if (collection == null)
                throw new ArgumentNullException(nameof(collection));
