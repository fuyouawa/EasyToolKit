...
namespace EasyToolKit.Inspector.Editor
{
    ...
    public abstract class AttributeResolverBase : ResolverBase, IAttributeResolver
    {
        ...
        protected abstract ElementAttributeSource GetAttributeSource(Attribute attribute);
        ...
        ElementAttributeSource IAttributeResolver.GetAttributeSource(Attribute attribute)
        {
            EnsureInitialize();
