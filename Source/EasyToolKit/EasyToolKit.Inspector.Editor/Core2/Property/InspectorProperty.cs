...
namespace EasyToolKit.Inspector.Editor
{
    ...
    public class InspectorProperty : IDisposable
    {
        ...
        private IValueOperationResolver _operationResolver;
        ...
        public IValueOperation GetOperation()
        {
        ...
        public ElementAttributeSource GetAttributeSource(Attribute attribute)
        {
